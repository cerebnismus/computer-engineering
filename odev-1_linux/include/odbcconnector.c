...
int main() {
	...
	retcode = SQLDriverConnect(hdbc, NULL, "Driver={ODBC Driver 13 for SQL Server};Server=tcp:comportal.database.windows.net,1433;Database=comportal;Uid=kuragxon@comportal;Pwd={Ybayv4jqs*};Encrypt=yes;TrustServerCertificate=no;Connection Timeout=30;", SQL_NTS, outstr, sizeof(outstr), &outstrlen, SQL_DRIVER_NOPROMPT);
